                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            Aplicação web interativa para criação de diagramas de sistemas de controle.
                            Permite arrastar e soltar blocos de controle, conectá-los, configurar parâmetros
                            e exportar diagramas para formato CDU compatível com ANATEM.
                        </p>
                    </div>
