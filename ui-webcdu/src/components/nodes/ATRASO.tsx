      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            <text x="95" y="70" fontFamily="Arial" fontSize="15" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">-sP1</text>
            <text x="75" y="83" fontFamily="Arial" fontSize="25" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">e</text>
