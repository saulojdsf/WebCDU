      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            <line x1="2" y1="150" x2="2" y2="90" stroke="#000" strokeWidth="2" />
            <line x1="75" y1="150" x2="75" y2="90" stroke="#000" strokeWidth="2" />
            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill="#fff" stroke="#000" strokeWidth="2" />
            <text x="65" y="69.5" fontFamily="Arial" fontSize="20" fill="#000">{"P1"}</text>
            <line x1="50" y1="73.5" x2="100" y2="73.5" stroke="#000" strokeWidth="2" />
            <text x="70" y="92.5" fontFamily="Arial" fontSize="20" fill="#000">{"s"}</text>
