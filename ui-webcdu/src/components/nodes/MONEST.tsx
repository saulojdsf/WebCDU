...
export function MONEST(props: NodeProps & {
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill={isDarkMode ? "#333" : "#fff"} stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
                ...
                <line x1="30" x2="50" y1="50" y2="50" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="50" x2="50" y1="50" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="50" x2="130" y1="70" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />
                ...
                <line x1="60" x2="33" y1="91" y2="91" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <line x1="80" x2="107" y1="91" y2="91" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <text x="65" y="95" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{"P1"}</text>
