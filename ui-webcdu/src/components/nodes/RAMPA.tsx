        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill={isDarkMode ? "#333" : "#fff"} stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
                ...
                <line x1="40" x2="40" y1="90" y2="100" stroke={isDarkMode ? "#fff" : "#ccc"} />
                <line x1="100" x2="100" y1="100" y2="60" stroke={isDarkMode ? "#fff" : "#ccc"} />
                <line x1="20" x2="100" y1="60" y2="60" stroke={isDarkMode ? "#fff" : "#ccc"} />
                ...
                <line x1="20" x2="40" y1="90" y2="90" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="40" x2="100" y1="90" y2="60" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="100" x2="120" y1="60" y2="60" stroke={isDarkMode ? "#fff" : "#000"} />
