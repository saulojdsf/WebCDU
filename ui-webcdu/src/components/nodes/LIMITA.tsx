  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div
          ref={nodeRef}
          className={`bg-transparent rounded w-[50px] h-[150px] border-2 border-transparent flex flex-col items-center justify-center font-bold relative cursor-pointer transition-all duration-200 ${selectionStyles} ${isDarkMode ? "text-white" : "text-black"}`}
        ...
        >
          ...
          <svg className="w-[50px] h-[150px]">
            <text x="25" y="15" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{(props.data?.Vmax || "?")}</text>
            <line x1="25" y1="131.25" x2="25" y2="18.75" stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
            <line x1="25" y1="18.75" x2="50" y2="18.75" stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
            <line x1="25" y1="131.25" x2="0" y2="131.25" stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
            <text x="5" y="143" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{(props.data?.Vmin || "?")}</text>
            <rect x="1" y="37.5" width={48} height={75} rx={10} ry={10} fill={isDarkMode ? "#333" : "#fff"} stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
            <text x="25" y="78" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{props.type.toUpperCase()}</text>
