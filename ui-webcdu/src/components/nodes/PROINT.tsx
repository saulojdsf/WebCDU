...
export function PROINT(props: NodeProps & {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div
          ref={nodeRef}
          className={`bg-transparent rounded w-[150px] h-[150px] border-2 border-transparent flex flex-col items-center justify-center font-bold relative cursor-pointer transition-all duration-200 ${selectionStyles} ${isDarkMode ? "text-white" : "#000"}`}
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            <text x="55" y="92.5" fontFamily="Arial" fontSize="20" fill={isDarkMode ? "#fff" : "#000"}>{"sP3"}</text>
