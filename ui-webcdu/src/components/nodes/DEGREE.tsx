...
export function DEGREE(props : NodeProps & {
...
<div className={`absolute top-0 left-1 text-[10px] font-bold ${isDarkMode ? "text-white bg-gray-800" : "text-black bg-white"} bg-opacity-80 px-0 rounded`}>
    {"FUNCAO"}
</div>
