      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            <text x="75" y="69.5" font-family="Arial" font-size="20" fill="#000" textAnchor="middle">{"P1"}</text>
            <line x1="30" y1="73.5" x2="120" y2="73.5" stroke="#000" stroke-width="2" />
            <text x="75" y="92.5" font-family="Arial" font-size="20" fill="#000" textAnchor="middle">{"1+sT"}</text>
