  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <Handle id="vin1" type="target" position={Position.Left} className="!absolute !top-[45px] !-left-3 !w-3 !h-3 !border-0 !bg-black"  />
          <Handle id="vin2" type="target" position={Position.Left} className="!absolute !top-[105px] !-left-3 !w-3 !h-3 !border-0 !bg-black"/>
