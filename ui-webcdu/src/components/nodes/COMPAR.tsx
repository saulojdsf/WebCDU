...
export function COMPAR(props: NodeProps & {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          <Handle id="vin1" type="target" position={Position.Left} className={`!absolute !top-[45px] !-left-3 !w-3 !h-3 !border-0 ${isDarkMode ? "!bg-white" : "!bg-black"}`}  />
          <Handle id="vin2" type="target" position={Position.Left} className={`!absolute !top-[105px] !-left-3 !w-3 !h-3 !border-0 ${isDarkMode ? "!bg-white" : "!bg-black"}`}/>
          <Handle id="vout" type="source" position={Position.Right} className={`!absolute !top-[75px] !-right-3 !w-3 !h-3 !border-0 ${isDarkMode ? "!bg-white" : "!bg-black"}`}/>

          <svg className="w-[150px] h-[150px]">
            <text x="5" y="35" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{"COMPAR"}</text>

            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill={isDarkMode ? "#333" : "#fff"} stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
            {props.type === "lt" && (<text x="75" y="100" fontFamily="Arial" fontSize="70" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{"<"}</text>)}
            {props.type === "le" && (<text x="75" y="100" fontFamily="Arial" fontSize="70" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{"≤"}</text>)}
            {props.type === "gt" && (<text x="75" y="100" fontFamily="Arial" fontSize="70" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{">"}</text>)}
            {props.type === "ge" && (<text x="75" y="100" fontFamily="Arial" fontSize="70" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{"≥"}</text>)}
            {props.type === "eq" && (<text x="75" y="100" fontFamily="Arial" fontSize="70" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{"="}</text>)}
            {props.type === "ne" && (<text x="75" y="100" fontFamily="Arial" fontSize="70" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">{"≠"}</text>)}
