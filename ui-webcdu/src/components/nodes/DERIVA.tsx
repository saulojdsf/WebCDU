...
export function DERIVA(props: NodeProps & {
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            <text x="5" y="35" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{"DERIVA"}</text>

            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill={isDarkMode ? "#333" : "#fff"} stroke={isDarkMode ? "#fff" : "#000"} strokeWidth="2" />
            <text x="75" y="83" fontFamily="Arial" fontSize="25" fill={isDarkMode ? "#fff" : "#000"} textAnchor="middle">s</text>
