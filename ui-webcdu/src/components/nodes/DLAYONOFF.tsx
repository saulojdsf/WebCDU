      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            ...
            {props.type === "dlayon" && (
              <>
                <line x1="20" y1="100" x2="20" y2="50" stroke={isDarkMode ? "#fff" : "#ccc"} marker-end="url(#arrow)" />

                <line x1="20" x2="30" y1="70" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="30" x2="30" y1="70" y2="50" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="30" x2="30" y1="61" y2="59" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <line x1="30" x2="90" y1="50" y2="50" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="90" x2="90" y1="50" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="90" x2="130" y1="70" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />

                <line x1="30" x2="30" y1="70" y2="100" stroke={isDarkMode ? "#fff" : "#ccc"} stroke-dasharray="0 4 0" />

                <line x1="20" x2="80" y1="100" y2="100" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="80" x2="80" y1="100" y2="80" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="80" x2="90" y1="80" y2="80" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="90" x2="90" y1="80" y2="100" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="90" x2="130" y1="100" y2="100" stroke={isDarkMode ? "#fff" : "#000"} />


                <line x1="45" x2="33" y1="91" y2="91" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <line x1="58" x2="76" y1="91" y2="91" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <text x="45" y="95" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{"P1"}</text>
              </>
            )}
            {props.type === "dlayof" && (
              <>
                ...
                <line x1="40" x2="40" y1="59" y2="61" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                
                <line x1="30" x2="40" y1="50" y2="50" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="40" x2="40" y1="50" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="40" x2="130" y1="70" y2="70" stroke={isDarkMode ? "#fff" : "#000"} />

                <line x1="40" x2="40" y1="70" y2="100" stroke={isDarkMode ? "#fff" : "#ccc"} stroke-dasharray="0 4 0" />

                <line x1="20" x2="30" y1="100" y2="100" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="30" x2="30" y1="100" y2="80" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="30" x2="110" y1="80" y2="80" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="110" x2="110" y1="80" y2="100" stroke={isDarkMode ? "#fff" : "#000"} />
                <line x1="110" x2="130" y1="100" y2="100" stroke={isDarkMode ? "#fff" : "#000"} />


                <line x1="68" x2="43" y1="91" y2="91" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <line x1="85" x2="107" y1="91" y2="91" stroke={isDarkMode ? "#fff" : "#000"} marker-end="url(#arrow2)" />
                <text x="70" y="95" fontFamily="Arial" fontSize="10" fill={isDarkMode ? "#fff" : "#000"}>{"P1"}</text>
              </>
            )}
