      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill="#fff" stroke="red" stroke-width="2" />
            <text x="75" y="83" font-family="Arial" font-size="25" fill="#000" textAnchor="middle">{"FIMPRG"}</text>
