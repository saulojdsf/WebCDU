...
export function XK(props: NodeProps & {
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <svg className="w-[150px] h-[150px]">
            <text x="5" y="35" font-family="Arial" font-size="10" fill="#000">{"FUNCAO"}</text>

            <rect x="0" y="37.5" width={150} height={75} rx={10} ry={10} fill="#fff" stroke="#000" stroke-width="2" />
            <text x="95" y="70" font-family="Arial" font-size="15" fill="#000" textAnchor="middle">P1/P2</text>
            <text x="75" y="83" font-family="Arial" font-size="25" fill="#000" textAnchor="middle">x</text>
